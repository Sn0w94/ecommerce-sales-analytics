...
## tags: [portfolio, ecommerce, sales-analytics, power-bi] status: in-progress created: 2026-05-26
...
|**Źródło danych**|`ecommerce_sales_data.csv`|
...
1. _(Do uzupełnienia)_
2. _(Do uzupełnienia)_
3. _(Do uzupełnienia)_
